...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/17_ngame-oracle-for-amazontitles-004'

    data_dir = None
    config_file = 'configs/17_ngame-oracle-for-amazontitles-004_category.json'
    config_key = 'data'
    ...
    pkl_file = f'{input_args.pickle_dir}/mogicX/amazontitles_data-gpt-category_distilbert-base-uncased'
