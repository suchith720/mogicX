# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/12_mogic-for-wikiseealsotitles-noise.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/12_mogic-for-wikiseealsotitles-noise.ipynb 3
...
# %% ../nbs/12_mogic-for-wikiseealsotitles-noise.ipynb 5
os.environ['CUDA_VISIBLE_DEVICES'] = '10,11'
os.environ['WANDB_PROJECT'] = 'mogicX_01-wikiseealsotitles'

# %% ../nbs/12_mogic-for-wikiseealsotitles-noise.ipynb 27
if __name__ == '__main__':
    ...
    # config_file = '/data/datasets/benchmarks/(mapped)LF-WikiSeeAlsoTitles-320K/configs/data_category_linker_noise-050.json'
    ...
    def model_fn(teacher_model, student_model, mname, meta_embed_init_file, do_inference, use_pretrained, bsz):
        ...
        if not do_inference or use_pretrained:
            ...
            model.m_student.set_label_remap(label_cluster_mapping)
    ...
    def init_fn(model):
        ...
        model.m_student.init_meta_embeddings()
        model.m_student.init_label_embeddings()
        model.m_student.encoder.freeze_pretrained_meta_embeddings()
    ...
    model = load_model(args.output_dir, model_fn, {'teacher_model': teacher_model, 'student_model': student_model, 'mname': None, 
                                                   'meta_embed_init_file': meta_embed_init_file, 'do_inference': do_inference, 
                                                   'use_pretrained': input_args.use_pretrained, 'bsz': bsz},
