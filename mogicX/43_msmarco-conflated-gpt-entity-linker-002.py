...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/43_msmarco-conflated-gpt-entity-linker-002'

    input_args = parse_args()

    config_file = '/data/datasets/msmarco/XC/configs/data-label_gpt-conflated-entity.json'
    config_key = 'data-label_gpt-conflated-entity'

    mname = 'sentence-transformers/msmarco-distilbert-cos-v5'

    pkl_file = get_pkl_file(input_args.pickle_dir, 'msmarco_data-label-gpt-conflated-entity_distilbert-base-uncased', 
