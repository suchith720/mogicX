...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/26_oak-for-msmarco-with-gpt-entity-linker-hyperparameter-search-002'
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, only_test=input_args.only_test, 
                        n_slbl_samples=3, main_oversample=False, n_sdata_meta_samples=5, meta_oversample=False, train_meta_topk=10, test_meta_topk=5)
