...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/41_msmarco-ngame-category-oracle-001'

    input_args = parse_args()
    
    if input_args.exact:
        config_file = 'configs/41_msmarco-ngame-category-oracle_ce-negatives_exact.json'
        config_key = 'data_exact'
    else:
        config_file = 'configs/41_msmarco-ngame-category-oracle_ce-negatives.json'
        config_key = 'data'
    
    mname = 'distilbert-base-uncased'

    pkl_file = get_pkl_file(input_args.pickle_dir, 'msmarco_data-ce-negatives-msmarco-ngame-category-oracle_distilbert-base-uncased', 
