...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/27_oak-for-msmarco-with-gpt-entity-linker-hyperparameter-search-002'
    ...
    def model_fn(mname, bsz):
        model = OAK004.from_pretrained(mname, batch_size=bsz, num_batch_labels=5000, margin=0.3, num_negatives=10, tau=0.001, apply_softmax=True,
