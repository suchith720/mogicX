...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/15_momos-for-wikititles-noise-001'

    data_dir = '/data/datasets/benchmarks/'
    config_file = '/home/aiscuser/scratch1/mogicX/configs/15_momos-for-wikititles-noise_data_hyper_link_ngame-linker.json'
    config_key = 'data_hyper_link_linker'

    model_output = '/data/outputs/mogicX/'
    meta_embed_file = '/data/datasets/ogb_weights/LF-WikiTitles-500K/emb_weights.npy'
