...
def additional_args():
    ...
    parser.add_argument('--compute_trn_metrics', action='store_true')
...
if __name__ == "__main__":
    ...
    output_dir = '/data/outputs/mogicX/54_nvembed-for-msmarco-001/predictions/msmarco/'
    ...
    if extra_args.compute_metrics:
        ...
        if extra_args.compute_trn_metrics:
            trn_mat = sp.load_npz('/data/datasets/beir/msmarco/XC/trn_X_Y.npz')
        ...
        def compute_metrics(data_repr, data_mat):
        ...
        print("Test metrics: ")
        compute_metrics(tst_repr, tst_mat)

        if extra_args.compute_trn_metrics:
            print("Train metrics: ")
            compute_metrics(trn_repr, trn_mat)
