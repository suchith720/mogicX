...
os.environ['WANDB_PROJECT'] = 'mogicX_00-msmarco-09'

# %% ../nbs/30_ngame-for-msmarco-with-hard-negatives.ipynb 6
if __name__ == '__main__':
    output_dir = '/data/outputs/mogicX/57_ngame-with-hard-negatives-ngame-category-linker-oracle-for-msmarco-001'
    ...
    if input_args.exact:
        config_file = 'configs/msmarco/msmarco_data-gpt-category-linker-ngame-linker_lbl_ce-negatives-topk-05-conflated-001-conflated-001-008_exact.json'
    else:
        config_file = 'configs/beir/msmarco/msmarco_data-gpt-category-linker-ngame-linker_conflated-001-conflated-001-008.json'
