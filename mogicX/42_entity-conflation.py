...
# %% auto 0
__all__ = ['show_conflated_labels', 'load_data', 'Filter', 'get_one_hop', 'normalize_matrix', 'get_init_components',
           'get_valid_components', 'get_conflated_info', 'get_id_to_cluster_idx_mapping', 'get_conflated_matrix',
           'get_conflated_path', 'save_conflated_data', 'main', 'parse_args']
...
# %% ../nbs/42_entity-conflation.ipynb 18
def get_init_components(data_lbl:sp.csr_matrix, lbl_ids:List, q:Optional[float]=50, batch_size:Optional[int]=1000):
...
# %% ../nbs/42_entity-conflation.ipynb 27
...
# %% ../nbs/42_entity-conflation.ipynb 28
...
# %% ../nbs/42_entity-conflation.ipynb 37
...
def main(pred_file:str, trn_file:str, tst_file:str, lbl_file:str, topk:Optional[int]=3,
         ...
         percentile_thresh:Optional[float]=50, encoding:Optional[str]='latin-1'):
    ...
    components = get_init_components(data_lbl, lbl_ids, q=percentile_thresh, batch_size=batch_size)
...
if __name__ == '__main__':
    ...
    main(args.pred_file, args.trn_file, args.tst_file, args.lbl_file, topk=args.topk, 
         ...
         percentile_thresh=args.percentile_thresh, encoding=args.encoding)
