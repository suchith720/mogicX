...
import os
os.environ['HIP_VISIBLE_DEVICES'] = '2,3,10,11'
...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/31_ngame-for-nq-from-scratch-003'

    input_args = parse_args()

    config_file = 'configs/31_ngame-for-nq-from-scratch-003_data_kaggle_categories.json'
    config_key = 'data_kaggle'

    mname = 'distilbert-base-uncased'

    pkl_file = f'{input_args.pickle_dir}/mogicX/nq_data-kaggle-categories_distilbert-base-uncased'
