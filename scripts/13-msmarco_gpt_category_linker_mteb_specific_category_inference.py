...
if __name__ == '__main__':
    ...
    config_file = f'/data/share/from_deepak/datasets/{input_args.dataset}/configs/data_gpt-category-linker.json'
    ...
    metric = PrecReclMrr(block.test.dset.data.n_lbl, block.test.dset.data.data_lbl_filterer, pk=10, rk=200, 
    ...
    oname = os.path.basename(output_dir)
    save_dir = f'/data/share/from_deepak/datasets/{input_args.dataset}/outputs/{oname}/'
    os.makedirs(save_dir, exist_ok=True)

    main(learn, input_args, n_lbl=block.test.dset.n_lbl, eval_k=10, train_k=10, save_dir=save_dir)
