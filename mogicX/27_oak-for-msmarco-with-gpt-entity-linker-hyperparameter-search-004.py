...
os.environ['WANDB_PROJECT'] = 'mogicX_00-msmarco-search-02'

# %% ../nbs/23_oak-for-msmarco-with-gpt-entity-linker.ipynb 7
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/27_oak-for-msmarco-with-gpt-entity-linker-hyperparameter-search-004'
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, only_test=input_args.only_test, 
                        n_slbl_samples=3, main_oversample=False, n_sdata_meta_samples=10, meta_oversample=False, train_meta_topk=10, test_meta_topk=10)
    ...
    args = XCLearningArguments(
        ...
        num_clustering_warmup_epochs=300,
    ...
    def model_fn(mname, bsz):
        model = OAK004.from_pretrained(mname, batch_size=bsz, num_batch_labels=5000, margin=0.3, num_negatives=100, tau=0.1, apply_softmax=True,
