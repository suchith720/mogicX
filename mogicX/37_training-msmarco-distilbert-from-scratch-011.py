...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/37_training-msmarco-distilbert-from-scratch-011'

    input_args = parse_args()

    if input_args.exact:
        config_file = '/data/datasets/msmarco/XC/configs/data_lbl_ce-negatives-topk-05_exact.json'
    else:
