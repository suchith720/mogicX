...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/50_distilbert-ngame-category-linker-oracle-for-msmarco-008'
    ...
    if input_args.exact:
        config_file = 'configs/msmarco_data-gpt-category-linker-ngame-linker_lbl_ce-negatives-topk-05-conflated-001-conflated-001-008_exact.json'
    else:
        config_file = 'configs/beir/msmarco_data-gpt-category-linker-ngame-linker_conflated-001_conflated-001_008.json'
