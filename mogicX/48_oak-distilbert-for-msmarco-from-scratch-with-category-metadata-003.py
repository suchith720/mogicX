...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/48_oak-distilbert-for-msmarco-from-scratch-with-category-metadata-003'
    ...
    block_args = {
        ...
        'train_meta_abs_thresh': {f'{meta_name}_meta':0.2},
        'test_meta_abs_thresh': {f'{meta_name}_meta':0.2},
        'train_meta_diff_thresh': {f'{meta_name}_meta':0.3},
        'test_meta_diff_thresh': {f'{meta_name}_meta':0.3},
    }
