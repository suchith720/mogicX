# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/15_mogic-for-wikititles-noise.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/15_mogic-for-wikititles-noise.ipynb 3
...
# %% ../nbs/15_mogic-for-wikititles-noise.ipynb 5
os.environ['CUDA_VISIBLE_DEVICES'] = '0,1'
os.environ['WANDB_PROJECT'] = 'mogicX_01-wikititles'

# %% ../nbs/15_mogic-for-wikititles-noise.ipynb 7
if __name__ == '__main__':
    output_dir = '/scratch/scai/phd/aiz218323/outputs/mogicX/15_mogic-for-wikititles-noise'

    config_file = '/home/scai/phd/aiz218323/scratch/datasets/benchmarks/(mapped)LF-WikiTitles-500K/configs/data_hyper_link_linker_noise-050.json'
    ...
    meta_embed_init_file = '/data/OGB_Weights/LF-WikiTitles-500K/emb_weights.npy'
    
    meta_name = 'lnk'

    input_args = parse_args()

    pkl_file = f'{input_args.pickle_dir}/mogicX/wikititles-noise_data-hyper-link-linker_distilbert-base-uncased'
