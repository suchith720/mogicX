...
if __name__ == '__main__':
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, 
                        only_test=input_args.only_test, data_dir=data_dir, n_sdata_meta_samples=3, meta_oversample=True)

    data_dir = None
    # config_file = '/home/aiscuser/scratch1/datasets/benchmarks/20250123-combined-LF-WikiSeeAlsoTitles-320K/configs/data_category_old-old-new.json'
    # config_key = 'data_category_old-old-new'
    # config_file = '/home/aiscuser/scratch1/datasets/benchmarks/20250123-combined-LF-WikiSeeAlsoTitles-320K/configs/data_category_old-old-combined.json'
    # config_key = 'data_category_old-old-combined'
    ...
    config_file = '/home/aiscuser/scratch1/datasets/benchmarks/20250123-combined-LF-WikiSeeAlsoTitles-320K/configs/data_category_new-new-combined.json'
    config_key = 'data_category_new-new-combined'

    # pkl_file = f'{input_args.pickle_dir}/mogicX/wikiseealsotitles-combined-20250123_data-category-old-old-new_distilbert-base-uncased'
    # pkl_file = f'{input_args.pickle_dir}/mogicX/wikiseealsotitles-combined-20250123_data-category-old-old-combined_distilbert-base-uncased'
    # pkl_file = f'{input_args.pickle_dir}/mogicX/wikiseealsotitles-20250123_data-category_distilbert-base-uncased'
    pkl_file = f'{input_args.pickle_dir}/mogicX/wikiseealsotitles-combined-20250123_data-category-new-new-combined_distilbert-base-uncased'
    pkl_file = f'{pkl_file}_sxc' if input_args.use_sxc_sampler else f'{pkl_file}_xcs'
    if input_args.only_test: pkl_file = f'{pkl_file}_only-test'
    pkl_file = f'{pkl_file}.joblib'
    ...
    def model_fn(teacher_model, student_model, mname, do_inference, use_pretrained, bsz):
        ...
        m_student = OAK007.from_pretrained(student_model, batch_size=bsz, num_batch_labels=5000, margin=0.3, 
                                           ...
                                           n_labels=block.n_lbl, n_clusters=n_clusters, use_query_loss=True, use_encoder_parallel=False)
    ...
    # Evaluate on another dataset block
    # learn = XCLearner(
    ...
    # learn.args.label_names = ['lbl2data_idx', 'lbl2data_input_ids', 'lbl2data_attention_mask', 'lbl2data_data2ptr', 'plbl2data_idx', 'plbl2data_data2ptr']
    #     
    # o = learn.predict(eval_block.lbl_dset)
    # pred = get_output(o.pred_idx, o.pred_ptr, o.pred_score, n_lbl=block.n_lbl)

    # pred_dir = f'{learn.args.output_dir}/predictions'
    # sp.save_npz(f'{pred_dir}/wikiseealsotitles-20250123-label_predictions.npz', pred)
    ...
    idx = np.where(eval_block.test.dset.data.data_lbl.getnnz(axis=1) > 0)[0]
    eval_block.test.dset = eval_block.test.dset._getitems(idx)
