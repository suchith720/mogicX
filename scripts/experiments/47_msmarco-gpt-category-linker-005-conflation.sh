...
output_dir=/data/outputs/mogicX/47_msmarco-gpt-category-linker-005/

trn_file="/data/datasets/msmarco/XC/category-gpt-linker_trn_X_Y.npz"
tst_file="/data/datasets/msmarco/XC/category-gpt-linker_tst_X_Y.npz"
lbl_file="/data/datasets/msmarco/XC/raw_data/category-gpt-linker.raw.csv"
...
if [ $TYPE == "experiment" ]
then
	output_dir=outputs/47_msmarco-gpt-category-linker-005
	mkdir -p $output_dir
	...
	if [ -d $output_dir ]
	then
		lbl_file=$output_dir/raw_data/category-gpt-linker_conflated.raw.csv
