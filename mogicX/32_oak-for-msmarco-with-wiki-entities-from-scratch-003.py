...
if __name__ == '__main__':
    ...
    if input_args.exact:
        config_file = '/data/datasets/msmarco/XC/configs/data_wiki-entity_ngame_exact.json'
        config_key = 'data_wiki-entity-ngame_exact'
    else:
    ...
    meta_name = 'ent'
    meta_embed_init_file = '/data/outputs/mogicX/01-msmarco-gpt-entity-linker-001/predictions/label_repr_wiki-msmarco.pth'

    pkl_file = f'{input_args.pickle_dir}/mogicX/msmarco_data-wiki-entity-ngame_distilbert-base-uncased'
