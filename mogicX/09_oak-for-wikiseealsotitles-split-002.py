# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/09_oak-for-wikiseealsotitles-split.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/09_oak-for-wikiseealsotitles-split.ipynb 3
...
# %% ../nbs/09_oak-for-wikiseealsotitles-split.ipynb 5
os.environ['CUDA_VISIBLE_DEVICES'] = '2,3'
os.environ['WANDB_PROJECT'] = 'mogicX_01-wikiseealsotitles'

# %% ../nbs/09_oak-for-wikiseealsotitles-split.ipynb 20
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/09_oak-for-wikiseealsotitles-split-002'
 
    config_file = '/home/aiscuser/scratch1/mogicX/configs/09_oak-for-wikiseealsotitles-split-002.json'
    ...
    pkl_file = f'{input_args.pickle_dir}/mogicX/wikiseealsotitles-split-for-oak_09-oak-for-wikiseealsotitles-split-002_distilbert-base-uncased'
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, only_test=input_args.only_test,
                        n_sdata_meta_samples=3, meta_oversample=False, test_meta_topk=3)
    block.train.dset.meta['lnk_meta'].meta_oversample = True
