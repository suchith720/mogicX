...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/37_training-msmarco-distilbert-from-scratch-006'

    input_args = parse_args()

    if input_args.exact:
        config_file = '/data/datasets/msmarco/XC/configs/data_ce-negatives-topk-05_exact.json'
    ...
    pkl_file = get_pkl_file(input_args.pickle_dir, 'msmarco_data-ce-negatives-topk-05_distilbert-base-uncased', input_args.use_sxc_sampler, 
