...
if __name__ == '__main__':
    output_dir = "/data/outputs/mogicX/55_ngame-for-all-beir-from-scratch-001"
    ...
    pkl_file = get_pkl_file(input_args.pickle_dir, f'{input_args.dataset.replace("/", "-")}_{fname}_{mname}', input_args.use_sxc_sampler, 
