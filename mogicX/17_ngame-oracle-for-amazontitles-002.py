# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/17_ngame-oracle-for-amazontitles.ipynb.

# %% auto 0
__all__ = []

# %% ../nbs/17_ngame-oracle-for-amazontitles.ipynb 3
...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/17_ngame-oracle-for-amazontitles-002'

    data_dir = None
    config_file = 'configs/17_ngame-oracle-for-amazontitles-002_data-review-description.json'
    config_key = 'data'
    ...
    pkl_file = f'{input_args.pickle_dir}/mogicX/amazontitles_data-review-description_distilbert-base-uncased'
