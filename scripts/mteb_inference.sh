...
# 	python mogicX/33_ngame-mteb-inference-001.py  --use_sxc_sampler --pickle_dir /home/aiscuser/scratch1/datasets/processed/ --do_test_inference --dataset $dataset >> $output_file
# done
...
# do
# 	echo $dataset : >> $output_file
# 	python mogicX/33_oak-mteb-inference-002.py  --use_sxc_sampler --pickle_dir /home/aiscuser/scratch1/datasets/processed/ --do_test_inference --dataset $dataset >> $output_file
# done
