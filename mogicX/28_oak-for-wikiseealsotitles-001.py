...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/28_oak-for-wikiseealsotitles-001'
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, data_dir=data_dir, do_build=input_args.build_block, only_test=input_args.only_test, 
