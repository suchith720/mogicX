...
if __name__ == '__main__':
    ...
    output_dir = '/data/outputs/mogicX/37_training-msmarco-distilbert-from-scratch-011'
    ...
    config_file = 'configs/msmarco_lbl-lbl.json'
    ...
    args = XCLearningArguments(
        ...
        search_normalize=input_args.normalize,
    ...
    learn = XCLearner(
        model=model,
        args=args,
        train_dataset=block.train.dset if block.train else None,
