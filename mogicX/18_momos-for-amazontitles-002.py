...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/18_momos-for-amazontitles-002'

    data_dir = '/data/datasets/benchmarks/'
    config_file = 'configs/18_momos-for-amazontitles-002_data_category_ngame-linker.json'
    config_key = 'data_category_linker'

    model_output = '/data/outputs/mogicX/17_ngame-oracle-for-amazontitles-002/'
    meta_embed_file = '/data/outputs/mogicX/16_ngame-linker-for-amazontitles-004/predictions/label_repr.pth'
    
    meta_name = 'lnk'

    input_args = parse_args()

    pkl_file = f'{input_args.pickle_dir}/mogicX/amazontitles_18-momos-for-amazontitles-002-data-category-linker_distilbert-base-uncased'
