...
if __name__ == '__main__':
    output_dir = '/data/outputs/mogicX/47_msmarco-gpt-category-linker-006'
    ...
    config_file = '/data/datasets/msmarco/XC/configs/data_gpt-category-linker_conflated-001.json'
