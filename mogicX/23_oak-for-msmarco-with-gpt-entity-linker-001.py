...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/23_oak-for-msmarco-with-gpt-entity-linker-001'
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, only_test=input_args.only_test, 
                        n_slbl_samples=3, main_oversample=False, n_sdata_meta_samples=3, meta_oversample=True, train_meta_topk=5, test_meta_topk=3)
