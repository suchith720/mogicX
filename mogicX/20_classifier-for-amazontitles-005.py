...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/20_classifier-for-amazontitles-005'

    data_dir = '/data/datasets/benchmarks/G_Datasets/'
    config_file = 'amazontitles'
    config_key = 'data'

    teacher_dir = '/data/outputs/mogicX/17_ngame-oracle-for-amazontitles-002/'
    classifier_dir = '/data/outputs/mogicX/18_momos-for-amazontitles-001/' 
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, only_test=input_args.only_test,
                        n_slbl_samples=4, main_oversample=False, data_dir=data_dir)
    ...
    m_student = CLS001.from_pretrained(f'{classifier_dir}/representation', n_train=block.train.dset.n_data, 
                                       ...
                                       num_batch_labels=5000, margin=0.2, num_negatives=5, tau=0.1, apply_softmax=True)
    
    m_student.freeze_representation()
    m_student.init_lbl_embeddings()

    """ Distillation model """
    model = DTL006(DistilBertConfig(), m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.2, tau=0.1, 
                   n_negatives=5, apply_softmax=True, teacher_data_student_label_loss_weight=0.1, 
