...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/21_momos-for-wikititles-hyperparameter-search-001'
    # output_dir = '/data/outputs/medic/32_momos-for-wikititles-002/' 
    ...
    if do_inference:
        ...
        model = DTL004.from_pretrained(mname, m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
                ...
                data_mse_loss_weight=10.0, label_mse_loss_weight=0.0)
    else:
        model = DTL004(DistilBertConfig(), m_student=m_student, m_teacher=m_teacher, bsz=bsz, tn_targ=5000, margin=0.3, tau=0.1, 
                       ...
                       student_data_teacher_label_loss_weight=0.0, data_mse_loss_weight=10.0, label_mse_loss_weight=0.0)
