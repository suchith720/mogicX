...
import os
os.environ['HIP_VISIBLE_DEVICES'] = '10,11,12,13,14,15'
...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/27_oak-for-msmarco-with-gpt-entity-linker-hyperparameter-search-008'
    ...
    metric = PrecReclMrr(block.n_lbl, block.test.data_lbl_filterer, pk=10, rk=200, rep_pk=[1, 3, 5, 10], rep_rk=[10, 100, 200], mk=[5, 10, 20])
