...
if __name__ == '__main__':
    output_dir = '/scratch/scai/phd/aiz218323/outputs/mogicX/05_mogic-meta-encoder-for-wikiseealsotitles'
    ...
    args = XCLearningArguments(
        ...
        label_names=['lbl2data_idx', 'lbl2data_input_ids', 'lbl2data_attention_mask', f'{meta_name}2data_idx', 
                     f'{meta_name}2data_input_ids', f'{meta_name}2data_attention_mask'],
