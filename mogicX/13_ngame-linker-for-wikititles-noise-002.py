...
if __name__ == '__main__':
    ...
    # trn_meta = du.read_sparse_file('/data/datasets/benchmarks/(mapped)LF-WikiTitles-500K//hyper_link_trn_X_Y.txt')
    # tst_meta = du.read_sparse_file('/data/datasets/benchmarks/(mapped)LF-WikiTitles-500K//hyper_link_tst_X_Y.txt')

    # block.train.dset.meta['hlk_meta'].data_meta = trn_meta
