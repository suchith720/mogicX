...
if __name__ == '__main__':
    output_dir = "/home/aiscuser/scratch1/outputs/mogicX/55_ngame-for-all-beir-from-scratch-001"
    ...
    if input_args.exact:
        ...
        config_file = '/data/datasets/beir/all-beir/XC/configs/data.json'

    config_key, fname = get_config_key(config_file)
    mname = 'distilbert-base-uncased'

    pkl_file = get_pkl_file(input_args.pickle_dir, f'all-beir_{fname}_{mname}', input_args.use_sxc_sampler, 
    ...
    block = build_block(pkl_file, config_file, input_args.use_sxc_sampler, config_key, do_build=input_args.build_block, 
                        only_test=input_args.only_test, main_oversample=False, n_slbl_samples=1)
