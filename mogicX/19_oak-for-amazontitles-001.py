...
os.environ['WANDB_PROJECT'] = 'mogicX_03-amazontitles'
...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/19_oak-for-amazontitles-001'

    data_dir = '/data/datasets/benchmarks/'
    config_file = '/data/datasets/benchmarks/G_Datasets/LF-AmazonTitles-1.3M/configs/data_category_ngame-linker.json'
    config_key = 'data_category_linker'

    model_output = '/data/outputs/mogicX/17_ngame-oracle-for-amazontitles-002/'
    meta_embed_file = '/data/datasets/ogb_weights/LF-AmazonTitles-1.3M/emb_weights.npy'
    
    meta_name = 'lnk'

    input_args = parse_args()

    pkl_file = f'{input_args.pickle_dir}/mogicX/amazontitles_data-category-linker_distilbert-base-uncased'
    ...
    mname = f'{output_dir}/{os.path.basename(get_best_model(output_dir))}' if do_inference else 'sentence-transformers/msmarco-distilbert-base-v4'
    m_student = OAK008.from_pretrained(mname, batch_size=bsz, num_batch_labels=5000,
