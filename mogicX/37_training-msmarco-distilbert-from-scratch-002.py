...
if __name__ == '__main__':
    ...
    if input_args.exact:
        config_file = '/data/datasets/msmarco/XC/configs/data_ce-negatives-probs_exact.json'
    ...
    pkl_file = get_pkl_file(input_args.pickle_dir, 'msmarco_data-ce-negatives-probs_distilbert-base-uncased', input_args.use_sxc_sampler, 
