...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/47_msmarco-gpt-category-linker-003'
    ...
    config_file = '/data/datasets/msmarco/XC/configs/data_gpt-category-conflated-001.json'
