...
if __name__ == '__main__':
    output_dir = '/home/aiscuser/scratch1/outputs/mogicX/12_momos-for-wikiseealsotitles-noise-003'
    ...
    with torch.no_grad():
        m_teacher.data_repr.weight.copy_(torch.randn_like(m_teacher.data_repr.weight))
        m_teacher.lbl_repr.weight.copy_(torch.randn_like(m_teacher.lbl_repr.weight))
